...
| [prefab_system.md](prefab_system.md) | designed | An authored entity subtree as a reusable asset: the `.sushiprefab` file, the instance component, refresh on scene load, and the link that makes an imported model a prefab. |
