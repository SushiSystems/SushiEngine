...
| P9-D | [physics_system.md](physics_system.md) | open | Rollback snapshot integration and the 10,000-tick byte-equality test. **The one item in this row that needs no GPU**, since §0.5 makes determinism a build-time property and the CPU backend is deterministic. |
