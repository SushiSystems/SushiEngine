...
| P9-B | [physics_system.md](physics_system.md) | open | A character controller. P9-A landed 2026-08-07 (§16.46) and was its only prerequisite: the capsule it stands in is a kinematic body, which now exists. |
