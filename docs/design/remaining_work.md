...
| PROF4 | [profiling_system.md](profiling_system.md) | open | The polish pass and the architecture chapter. PROF0's Profiler panel, PROF1's `engine/foundation/profiling` module and instrumented editor loop, PROF2's renderer counters and memory budgets, and PROF3's system metrics provider are built. |
