...
| PROF3–PROF4 | [profiling_system.md](profiling_system.md) | open | The editor-owned system metrics provider and the polish pass. PROF0's Profiler panel, PROF1's `engine/foundation/profiling` module and instrumented editor loop, and PROF2's renderer counters and memory budgets are built. |
