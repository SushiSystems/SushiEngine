...
# sushiengine_apply_sycl(<target> [SOURCES <src>...])
...
function(sushiengine_apply_sycl target)
...
# sushiengine_add_sycl_executable(<name> <source>)
...
function(sushiengine_add_sycl_executable name source)
    add_executable(${name} ${source})
    target_link_libraries(${name} PRIVATE SushiEngine)
    set_target_properties(${name} PROPERTIES
        CXX_STANDARD 17
        CXX_STANDARD_REQUIRED ON)
    sushiengine_apply_sycl(${name} SOURCES ${source})
endfunction()
