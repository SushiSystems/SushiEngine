    ...
    namespace Render
    {
        namespace Vulkan
        {
                                                                ...
                                                                FrameImage& out_image)
            {
                ...
                // Fully qualified: SushiEngine::Geometry (domain geometry module, Task 1) is a
                ...
                // three_quarter_camera_for_bounds, none of which it declares.
                ...
                {
                    // Mesh is a free-standing type in this file's own enclosing
                    // Render::Geometry namespace (engine/presentation/render/source/geometry/
                    // mesh_registry.hpp), not nested inside MeshRegistry -- confirmed by
                    // reading that header directly (Task 5 Step 3 item 1). The accessor is
                    // MeshRegistry::mesh(MeshId) const, returning const Mesh&.
